        ...
        success: function(data){
            ...
            data.datos.forEach(function (consulta){
                tablaconsulta.row.add( [
                    ...
                    '<button type="button" onclick="altaMascota('+consulta.id+')" class="d-inline m-1 btn btn-danger btn-sm"><span class="glyphicon glyphicon-pencil"></span></button>'
                ]).draw(); 
            });
