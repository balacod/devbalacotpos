...
class PackagesController extends BaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $packages_details['is_active_parka'] = empty($packages_details['is_active_parka']) ? 0 : 1;
