    ...
    <div class="col-md-6 col-sm-8">
        <div class="form-group">
            <div class="input-group">
                ...
                {!! Form::select('mascota_id', [], null, ['class' => 'form-control', 'id' => 'contact_pets_id', 'style' => 'width: 100%;', 'data-placeholder' => __('lang_v1.select_contact_pets'), 'data-no-results' => __('lang_v1.select_contact_pets_no_results')]); !!}
            </div>
        </div>
    </div>
    @endif
